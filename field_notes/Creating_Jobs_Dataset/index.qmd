...
The 2018 Apra salary survey had 668 participants, which means the 2017 CMAP data covered potentially about 64% of the jobs along the same time frame. Obviously there are a million caveats to that - I'm guessing my filtering of CMAP maybe cut out some of the jobs, and there's no guarantee that there was substantial overlap between those two datasets. That's a rabbit hole for another day.
