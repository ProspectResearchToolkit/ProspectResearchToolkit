---
title: "Tool Reviews Staging Ground"
author: Greg Brooks
date: 01-09-2025
draft: true
categories:
...
## The Official Board
A website that is largely behind a paywall, but it also has some education on job titles that is particularly relevant. Mostly useful for big company org charts.


## Library Consortiums

"Quick pattern summary & tips for out-of-state access

Most statewide consortia restrict remote access to residents or to people who hold a participating library/school account. (Examples above show Geo-IP or library-card authentication is common.)

- Workarounds that often work in practice:

  - Visit a member library in person — public/academic libraries usually allow on-site access to licensed business databases for any visitor using library terminals. (This is the most reliable route.)

Get a guest card or temporary pass — some state libraries or public libraries offer short-term passes (e.g., 10-day NC LIVE pass) or guest cards; check the local library’s “e-resources” or access/FAQ pages.

Interlibrary loan or research visits — for academic research, contact the consortium or a member university library to ask about visiting scholar policies or ILL/document delivery.

Local public libraries’ reciprocal agreements — some public library systems participate in reciprocal programs (statewide cards, TexShare card, Access PA), so if you live nearby one state border check cross-state agreements."
